...
# Clonal-base gene signature
load(file='/data/lasso_cox_res.RData')
clonal.sig <- data.frame(Gene=names(active.k.vals), beta=active.k.vals)


RiskEstiPlot(losic.gene.exp, clonal.sig, 'median', 'Clonal-base signature', 'clonal_risk_sig_losic')

RiskEstiPlot(shi.gene.exp, clonal.sig, 'median', 'Clonal-base signature', 'clonal_risk_sig_shi')
